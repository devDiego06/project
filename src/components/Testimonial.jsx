...
import { TestimonialMap } from './TestimonialMap'
    ...
    const [testimonials, setTestimonials] = useState([
        {
            ...
            name: "Alissa",
            message: "Que buen producto",
            image: "../src/assets/img4.jpg",
        },
        {

            name: "John",
            message: "Que buen producto x2",
            image: "../src/assets/img5.jpg",
        },
        {
            
            name: "Diego",
            message: "Que buen producto x3",
    ...
    <div className="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
      <h2 className="text-center text-4xl font-bold tracking-tight text-white sm:text-5xl">
        ...
        {testimonials.map((testimonial,index) => {
          return (
              <div key={index} className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-8 sm:flex">
